...
<div class="container">
    ...
    <div class="row mt-lg-n4 mt-md-n4 justify-content-center">
        <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12 mb-3">
            <div class="card rounded-0">
                <div class="card-body">
                    ...
                    <center>
                        <hr style="height:2px;width:5em;opacity:1" class="bg-primary">
                    </center>
                    <dl>
        ...
        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 mb-3">
            <div class="card rounded-0">
                <div class="card-body">
                    <h3 class="text-center"><b>Envíanos un mensaje</b></h3>
                    <center>
                        <hr style="height:2px;width:5em;opacity:1" class="bg-primary">
                    </center>
                    <form id="inquiry-form">
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    <label for="fullname" class="control-label">Nombre <small class="text-danger">*</small></label>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-6 col-md-8 col-sm-12 col-xs-12">
                                <button class="btn btn-primary border-0 btn-block rounded-pill btn-lg bg-info"><i class="fa fa-paper-plane"></i> Enviar Mensaje</button>
                            </div>
                        </div>
                    </form>
                </div>
