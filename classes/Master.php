...
class Master extends DBConnection
{
	...
	function save_service()
	{
		...
		if ($save) {
			...
			$resp['status'] = 'success';
			if (empty($id))
				$resp['msg'] = "Servicio agregado, correctamente.";
			else
				$resp['msg'] = " Servicio actualizado, correctamente.";
			...
			if (!empty($_FILES['img']['tmp_name'])) {
				...
				if (!in_array($_FILES['img']['type'], $accept)) {
					$resp['msg'] += " Tipo de Imagen Inválido";
				} else {
