...
<section class="py-3">
    <div class="container">
        <div class="content bg-info py-5 px-3">
            <h4 class="">Nuestros Servicios Disponibles</h4>
        </div>
                        ...
                        <div class="row justify-content-center mb-3">
                            <div class="col-lg-8 col-md-10 col-xs-12 col-sm-12">
                                <div class="input-group input-group-lg">
                                    <input type="search" id="search" class="form-control rounded-pill px-3" placeholder="Buscar servicio por nombre o descripción">
