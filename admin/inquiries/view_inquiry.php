    ...
    <div class="col-lg-8 col-md-10 col-sm-12 col-xs-12">
        <div class="card card-outline card-dark rounded-0 shadow">
            ...
            <div class="card-footer py-1 text-center">
                <button id="delete_inquiry" class="btn btn-danger btn-flat bg-danger btn-sm" type="button"><i class="fa fa-trash"></i> Delete</button>
                <a class="btn btn-light btn-flat bg-light border btn-sm" href="./?page=inquiries"><i class="fa fa-angle-left"></i> Back to List</a>
            </div>
        </div>
    </div>
</div>
