	...
	<div class="card card-outline rounded-0 card-navy">
		...
		<div class="card-body">
			...
			<div class="form-group">
				...
				<div class="form-group">
					<label for="" class="control-label">Carátula del Sitio Web</label>
					<div class="custom-file">
				...
				<div class="form-group">
					<label for="" class="control-label">Galería de Imágenes</label>
					<div class="custom-file">
						...
						<label class="custom-file-label" for="customFile3">Examinar</label>
					</div>
					<small><i>Subir Imágenes</i></small>
				</div>
				<?php
		...
		<div class="card-footer">
			<div class="col-md-12">
				<div class="row">
					<button class="btn btn-sm btn-primary bg-info border-0" form="system-frm">Actualizar</button>
				</div>
			</div>
		</div>
...
<script>
	...
	$(document).ready(function() {
		$('.rem_img').click(function() {
			_conf("¿Deseas eliminar esta imagen de forma permanente?", 'delete_img', ["'" + $(this).attr('data-path') + "'"])
		})
