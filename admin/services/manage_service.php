...
<div class="content py-5 px-3 bg-info">
	<h2><b><?= isset($id) ? "Actualizar Información de Servicio" : "Ingresar Nuevo Servicio" ?></b></h2>
</div>
	...
	<div class="col-lg-10 col-md-10 col-sm-12 col-xs-12">
		<div class="card rounded-0">
			<div class="card-body">
				...
				<div class="container-fluid">
					<form action="" id="service-form">
						...
						<div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
							<label for="status" class="control-label">Imagen</label>
			...
			<div class="card-footer py-1 text-center">
				<button class="btn btn-primary btn-sm bg-info btn-flat border-0" form="service-form"><i class="fa fa-save"></i> Guardar</button>
				<a class="btn btn-light btn-sm bg-light border btn-flat" href="./?page=services"><i class="fa fa-times"></i> Cancelar</a>
			</div>
		</div>
	</div>
</div>
<script>
	function displayImg(input) {
		if (input.files && input.files[0]) {
			...
			$(input).siblings('.custom-file-label').html('Examinar')
		}
	}
