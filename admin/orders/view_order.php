            ...
            <div class="card-header py-1">
                <div class="card-tools">
                    <?php if (isset($status) && $status < 4) : ?>
                        <button class="btn btn-info btn-sm bg-info rounded-0" type="button" id="update_status">Update Status</button>
                    <?php endif; ?>
                    <button class="btn btn-navy btn-sm bg-navy rounded-0" type="button" id="print"><i class="fa fa-print"></i> Print</button>
                    <button class="btn btn-danger btn-sm bg-danger rounded-0" type="button" id="delete_data"><i class="fa fa-trash"></i> Delete</button>
                    <a class="btn btn-light btn-sm bg-light border rounded-0" href="./?page=orders"><i class="fa fa-angle-left"></i> Back to List</a>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            <div class="mb-3">
                                ...
                                <div class="pl-4">
                                    ...
                                    switch ($status) {
                                        case 0:
                                            echo '<span class="badge badge-secondary bg-secondary px-3 rounded-pill">Pending</span>';
                                            break;
                                        case 1:
                                            echo '<span class="badge badge-primary bg-info px-3 rounded-pill">Packed</span>';
                                            break;
                                        case 2:
                                            echo '<span class="badge badge-warning bg-warning px-3 rounded-pill">Out for Delivery</span>';
                                            break;
                                        case 3:
                                            echo '<span class="badge badge-info bg-info px-3 rounded-pill">Paid</span>';
                                            break;
                                        default:
                                            echo '<span class="badge badge-light bg-light border dark px-3 rounded-pill">N/A</span>';
                                            break;
                                    }
                                    ?>
                                </div>
