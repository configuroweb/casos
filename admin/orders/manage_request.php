	...
	<div class="col-lg-6 col-md-8 col-sm-12 col-xs-12">
		<div class="card rounded-0">
			...
			<div class="card-footer py-1 text-center">
				<button class="btn btn-primary btn-sm bg-info btn-flat border-0" form="request-form"><i class="fa fa-save"></i> Save</button>
				<a class="btn btn-light btn-sm bg-light border btn-flat" href="./?page=requests"><i class="fa fa-angle-left"></i> Cancel</a>
			</div>
		</div>
	</div>
</div>
