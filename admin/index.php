        ...
        <div class="modal-dialog modal-md modal-dialog-centered rounded-0" role="document">
          <div class="modal-content rounded-0">
            ...
            <div class="modal-footer">
              <button type="button" class="btn btn-primary bg-info border-0 rounded-0" id='submit' onclick="$('#uni_modal form').submit()">Guardar</button>
      ...
      <div class="modal fade" id="confirm_modal" role='dialog'>
        <div class="modal-dialog modal-md modal-dialog-centered rounded-0" role="document">
          <div class="modal-content rounded-0">
            ...
            <div class="modal-footer">
              <button type="button" class="btn btn-primary  bg-info border-0 rounded-0" id='confirm' onclick="">Continuar</button>
